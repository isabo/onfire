...
function Ka(a,b,c,d,f){function k(a){r||(r=!0,d.call(f,a))}function l(a){r||(r=!0,c.call(f,a))}var r=!1;try{b.call(a,l,k)}catch(M){k(M)}}function Ia(a){a.h||(a.h=!0,va(a.l,a))}function La(a){var b=null;a.b&&(b=a.b,a.b=b.next,b.next=null);a.b||(a.c=null);return b}
I.prototype.l=function(){for(var a=null;a=La(this);){var b=this.a,c=this.i;if(b==N&&a.a&&!a.f)for(var d=void 0,d=this;d&&d.f;d=d.g)d.f=!1;if(a.child)a.child.g=null,Ma(a,b,c);else try{a.f?a.c.call(a.b):Ma(a,b,c)}catch(f){Na.call(null,f)}ha(Ba,a)}this.h=!1};function Ma(a,b,c){b==L?a.c.call(a.b,c):a.a&&a.a.call(a.b,c)}function Ja(a,b){a.f=!0;va(function(){a.f&&Na.call(null,b)})}var Na=sa;var Oa="undefined"!==typeof Promise;function O(a){return Oa?new Promise(a):new I(a)}function Pa(a){if(Oa)a=Promise.resolve(a);else if(!(a instanceof I)){var b=new I(h);K(b,L,a);a=b}return a}function Qa(a){return Oa?Promise.all(a):Fa(a)};var Ra=A?require("firebase"):Firebase;function Sa(a,b){return O(function(c,d){if(void 0!==b)var f=a.push(b,function(a){a?d(a):c(f)});else c(a.push())})}function Ta(a,b){return O(function(c,d){a.set(b,function(a){a?d(a):c()})})}function Ua(a,b){return O(function(c,d){a.update(b,function(a){a?d(a):c()})})}function Va(a,b){return O(function(c,d){a.transaction(b,function(a,b,l){a?d(a):c({isCommitted:b,snapshot:l})},!1)})}function Wa(a){return O(function(b,c){a.remove(function(a){a?c(a):b()})})}
...
function vb(a,b){a.c=b;var c=[],d;for(d in a.c){var f;switch(t(a.c[d])){case x:case y:case z:break;case u:case w:case v:f=a[d+"Ctor_"];a[d+"Inst_"]=new f(a.ref.child(d));c.push(a[d+"Inst_"].m);a.C.push(a[d+"Inst_"]);break;default:throw new TypeError("Invalid property type for "+d);}}a.m=a.m.then(function(){return Qa(c)}).then(function(){a.a=!0;return a});a.a=!1}
...
Z.prototype.forEach=function(a){if(!this.a)throw Error("Not loaded yet");var b=[],c;for(c in this.b){var d=this.f?this.fetch(c):Pa(this.o(c)),d=d.then(function(b,c){return a.call(null,c,b)}.bind(null,c));b.push(d)}return Qa(b)};Z.prototype.forEach=Z.prototype.forEach;Z.prototype.count=function(){if(!this.a)throw Error("Not loaded yet");return this.g};Z.prototype.count=Z.prototype.count;Z.prototype.j=function(a){if(!this.a)throw Error("Not loaded yet");return!!this.b&&a in this.b};
Z.prototype.containsKey=Z.prototype.j;Z.prototype.keys=function(){if(!this.a)throw Error("Not loaded yet");return F(this.b)};Z.prototype.keys=Z.prototype.keys;Z.prototype.N=function(a){this.A=a};Z.prototype.onChildAdded=Z.prototype.N;Z.prototype.O=function(a){this.B=a};Z.prototype.onChildRemoved=Z.prototype.O;Z.prototype.S=function(a){this.b||(this.b={});var b=a.key(),c=!this.j(b);this.b[b]=a.val();c&&(this.g++,this.A&&this.A.call(null,a.key()))};
Z.prototype.T=function(a){var b=a.key();this.j(b)&&(delete this.b[b],this.g--,0===this.g&&(this.b=null),this.B&&this.B.call(null,a.key()))};function yb(a){switch(typeof a){case "function":return a;case "object":break;default:throw Error("Invalid schema - it must be an object or a constructor!");}return t(a)===v?zb(a):Ab(a)}function Ab(a){function b(b){Y.call(this,b);vb(this,a)}q(b,Y);var c={};ja(c,a);b.getSchema=function(){return c};Bb(b,a);return b}
function zb(a){function b(a){Z.call(this,a,d)}var c=a.$id,d;switch(t(c)){case u:d=c;break;case w:case v:d=Ab(c)}q(b,Z);var f={};ja(f,a);b.getSchema=function(){return f};b.getMemberCtor=function(){return d};return b}

...
X.prototype.G = function() {
  return this.j ? Cb(this, this.u).then(function(a) {
    a.u = {};
    a.j = !1;
    return a;
  }) : M(this);
...
Y.prototype.get = Y.prototype.m;
Y.prototype.i = function(a) {
  if (this.c) {
    if (this.v(a)) {
      return new this.c(this.a.f(a));
    }
    throw Error("No such key in theis collection: " + a);
  }
...
Y.prototype.containsKey = Y.prototype.v;
...
function Ib(a) {
  return function(b) {
    return 0 === arguments.length ? this.m(a) : this.s(a, b);
  };
}
function Jb(a) {
  return function() {

...
X.prototype.G = function() {
  return this.j ? Cb(this, this.m).then(function(a) {
    a.m = {};
    a.j = !1;
    return a;
  }) : M(this);
...
function Cb(a, b) {
  ...
  return a.a.w(b).then(function() {
    ...
    if (0 === c && 0 < a.f) {
      return r("CREATED " + a.a.a()), fb(a.a.h(), a);
    }
  }).then(function() {
    return a;
  });
...
function Db(a, b) {
  return a.a.v(function(a) {
    ...
    return b.isCommitted ? (r("CREATED " + a.a.a()), fb(a.a.h(), a).then(function() {
      return b;
    })) : b;
  });
}
...
Y.prototype.forEach = function(a) {
  var b = [], c;
  for (c in this.b) {
    var d = this.c ? this.F(c) : M(this.h(c));
    d.then(function(b) {
...
function Hb(a, b) {
  for (var c in b) {
    ...
    switch(m(d)) {
      ...
      ;
      case ka:
        void 0 === a.prototype[c] ? a.prototype[c] = Ib(c) : oa(c + " clashes with a built-in property or method. Use the generic .get(" + c + ") / .set(" + c + ", value) methods to access this property.");
        break;
      case ha:
      ;
      case q:
      ...
      case n:
        ...
        void 0 === a.prototype[c] ? a.prototype[c] = Jb(c) : oa(c + " clashes with a built-in property or method. Use the generic .getModel(" + c + ") method to access this property.");
        break;
      default:

...
S.prototype.B = function() {
  U(this);
  for (var a = this.a.C(), b = this.a.B(), c = [], d = 0;d < b.length;d++) {
...
S.prototype.C = function(a) {
  ...
  if ("string" == typeof a) {
    ...
    for (a = this.a.C(), c = 0;c < a.length;c++) {
      b = ta(b, a[c]);
    }
  }
  return b;
...
S.prototype.toString = function() {
  ...
  for (var a = [], b = this.a.B(), c = 0;c < b.length;c++) {
    for (var d = b[c], e = encodeURIComponent(String(d)), d = this.C(d), l = 0;l < d.length;l++) {
      var h = e;
...
W.prototype.offValue = W.prototype.D;
...
X.prototype.dispose = X.prototype.I;
function Bb(a, b) {
  a.g = b;
  var c = [], d;
  for (d in a.g) {
...
X.prototype.F = function() {
  return this.l ? Cb(this, this.u).then(function(a) {
    a.u = {};
    a.l = !1;
    return a;
  }) : M(this);
};
X.prototype.save = X.prototype.F;
function Cb(a, b) {
  var c = a.f, d = {}, e;
  for (e in b) {
    d[e] = a.j(e);
...
Y.prototype.s = function(a, b) {
  if (this.c) {
    throw Error(".set() is for primitive values, not models");
  }
  this.u[a] = b;
  this.l = !0;
  return this;
...
Y.prototype.fetch = Y.prototype.w;
...
Y.prototype.fetchOrCreate = Y.prototype.H;
Y.prototype.R = function(a) {
  if (!this.v(a)) {
    return M(null);
  }
  var b, c = this;
  return (this.c ? this.w(a) : M(this.h(a))).then(function(a) {
    b = a;
  }).then(function() {
    c.s(a, null);
    return c.F();
...
Y.prototype.forEach = function(a) {
  var b = [], c;
  for (c in this.b) {
    var d = this.c ? this.w(c) : M(this.h(c));
    d.then(function(b) {
...
function Ib(a) {
  return function(b) {
    return 0 === arguments.length ? this.j(a) : this.s(a, b);
  };
}
function Jb(a) {
  return function() {

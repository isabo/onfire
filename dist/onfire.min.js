...
function Ra(a,b,c,d){a instanceof E?Ta(a,Oa(b||aa,c||null,d)):a.then(b,c,d)}function Ta(a,b){a.b||a.a!=H&&a.a!=J||Ua(a);a.c?a.c.next=b:a.b=b;a.c=b}function Sa(a,b,c,d){var f=Oa(null,null,null);f.a=new E(function(a,k){f.f=b?function(c){try{var f=b.call(d,c);a(f)}catch(I){k(I)}}:a;f.b=c?function(b){try{var f=c.call(d,b);a(f)}catch(I){k(I)}}:k});f.a.g=a;Ta(a,f);return f.a}E.prototype.j=function(a){this.a=F;G(this,H,a)};E.prototype.l=function(a){this.a=F;G(this,J,a)};
function G(a,b,c){if(a.a==F){if(a==c)b=J,c=new TypeError("Promise cannot resolve to itself");else{var d;if(c)try{d=!!c.$goog_Thenable}catch(f){d=!1}else d=!1;if(d){a.a=1;Ra(c,a.j,a.l,a);return}d=typeof c;if("object"==d&&null!=c||"function"==d)try{var l=c.then;if(g(l)){Va(a,c,l);return}}catch(k){b=J,c=k}}a.i=c;a.a=b;a.g=null;Ua(a);b!=J||Wa(a,c)}}function Va(a,b,c){function d(b){l||(l=!0,a.l(b))}function f(b){l||(l=!0,a.j(b))}a.a=1;var l=!1;try{c.call(b,f,d)}catch(k){d(k)}}
function Ua(a){a.h||(a.h=!0,Ha(a.m,a))}function Xa(a){var b=null;a.b&&(b=a.b,a.b=b.next,b.next=null);a.b||(a.c=null);return b}E.prototype.m=function(){for(var a=null;a=Xa(this);){var b=this.a,c=this.i;if(b==J&&a.b&&!a.g)for(var d=void 0,d=this;d&&d.f;d=d.g)d.f=!1;if(a.a)a.a.g=null,Ya(a,b,c);else try{a.g?a.f.call(a.c):Ya(a,b,c)}catch(f){Za.call(null,f)}qa(Na,a)}this.h=!1};function Ya(a,b,c){b==H?a.f.call(a.c,c):a.b&&a.b.call(a.c,c)}function Wa(a,b){a.f=!0;Ha(function(){a.f&&Za.call(null,b)})}
...
function P(a,b,c,d){a:{var f=O.b();if(null===a)b=M([null]);else{t("LOCAL_TRIGGER_GENERATED "+b.toUpperCase()+" at "+a.b());var l=[];a=a.b();for(var k=0;k<f.a.length;k++){var q=f.a[k][0],u=f.a[k][1],I=f.a[k][2],Ga=f.a[k][3];if(u===b){var Y=a.match(q);if(Y){t("LOCAL_TRIGGER_MATCHED at "+q.toString()+" on "+u.toUpperCase()+" for "+Ga.id());Y.push(c);"value"===b&&Y.push(d);try{var Fb=I.apply(Ga,Y.slice(1))}catch(Ma){t("LOCAL_TRIGGER_FAILED at "+q.toString()+" on "+u.toUpperCase(),Ma);b=Ma;b=K?Promise.reject(b):
...
W.prototype.transaction=W.prototype.v;W.prototype.w=function(a){t("UPDATE "+this.b()+" :",a);var b=this;return cb(this.a,a).then(function(){t("UPDATE (Success) "+b.b()+" :",a);return null},function(c){v("UPDATE (Failure) "+b.b()+" :",a,c);throw c;})};W.prototype.update=W.prototype.w;function X(a){if(!(a instanceof W))throw Error("ref argument must be an onfire.Ref instance");this.a=a;this.s={};this.l=!1;this.h=0;this.g=null;this.B=[];this.u=[];this.o=this.J()}m("onfire.model.Model",X);X.prototype.G=function(){t("DISPOSE  "+this.a.b()+" ...");delete this.o;for(var a=0;a<this.u.length;a++)this.a.i.apply(this.a,this.u[a]);this.C=null;for(a=0;a<this.B.length;a++)this.B[a].G();t("DISPOSED "+this.a.b())};X.prototype.dispose=X.prototype.G;
function Nb(a,b){a.g=b;var c=[],d;for(d in a.g){var f;switch(n(a.g[d])){case ha:case ia:case ja:break;case r:case p:f=a[d+"Ctor_"];a[d+"Inst_"]=new f(a.a.f(d));c.push(a[d+"Inst_"].o);a.B.push(a[d+"Inst_"]);break;default:throw new TypeError("Invalid property type for "+d);}}a.o=a.o.then(function(){return N(c)}).then(function(){a.c=!0;return a});a.c=!1}
X.prototype.J=function(){var a=this;return L(function(b,c){a.c=!1;var d=a.a.l(function(c){var d=a.c;Ob(a,c);d||b(a)},function(b){a.c||c(b)});a.u.push(["value",d])})};X.prototype.V=function(){return this.o};X.prototype.whenLoaded=X.prototype.V;X.prototype.H=function(){return this.a.s()};X.prototype.key=X.prototype.H;X.prototype.U=function(){return!!this.b};X.prototype.exists=X.prototype.U;X.prototype.O=function(a){this.C=a};X.prototype.onValueChanged=X.prototype.O;
function Ob(a,b){a.b=b;a.h=ra(b).length;a.c=!0;a.C&&a.C.call(null,a)}X.prototype.v=function(a){return a in this.g&&"string"!==typeof this.g[a]?this.j(a):this.i(a)};X.prototype.get=X.prototype.v;X.prototype.i=function(a){if(!this.c)throw Error("Not loaded yet");if(this.b&&a in this.b)return this.b[a];if(a in this.g)return null;throw Error("No such property: "+a);};X.prototype.getBasicValue=X.prototype.i;
X.prototype.j=function(a){if(a in this.g&&"string"!==typeof this.g[a])return this[a+"Inst_"];throw Error("No such property: "+a);};X.prototype.getModel=X.prototype.j;X.prototype.w=function(a,b){if(!this.c)throw Error("Not loaded yet");var c=this.b&&a in this.b;if(!(a in this.g||c))throw Error("No such property: "+a);this.s[a]=b;this.l=!0;return this};X.prototype.set=X.prototype.w;X.prototype.N=function(){return this.l};X.prototype.hasChanges=X.prototype.N;
X.prototype.I=function(){return this.l?Pb(this,this.s).then(function(a){a.s={};a.l=!1;return a}):M(this)};X.prototype.save=X.prototype.I;
...
function Qb(a,b){return a.a.v(function(a){if(null===a)return b}).then(function(b){return b.isCommitted?(t("CREATED "+a.a.b()),rb(a.a.h(),a).then(function(){return b})):b})};function Z(a,b){X.call(this,a);this.f=b}fa(Z,X);m("onfire.model.Collection",Z);Z.prototype.J=function(){var a=this,b=this.a.m().then(function(b){Ob(a,b);return a});b.then(function(){var b=a.a.g("child_added",a.L,void 0,a),d=a.a.g("child_removed",a.M,void 0,a);a.u.push(["child_added",b,a]);a.u.push(["child_removed",d,a]);a.c=!0});return b};Z.prototype.v=function(a){return this.f?this.j(a):this.i(a)};Z.prototype.get=Z.prototype.v;
Z.prototype.j=function(a){if(!this.f)throw Error("Cannot create a model for a primitive value");if(!this.c)throw Error("Not loaded yet");if(!this.m(a))throw Error("No such key in this collection: "+a);return new this.f(this.a.f(a))};Z.prototype.getModel=Z.prototype.j;Z.prototype.i=function(a){if(!this.c)throw Error("Not loaded yet");if(!this.m(a))throw Error("No such key in this collection: "+a);return this.b[a]};Z.prototype.getBasicValue=Z.prototype.i;
Z.prototype.w=function(a,b){if(this.f)throw Error(".set() is for primitive values, not models. Use .create() or .fetchOrCreate() instead.");this.s[a]=b;this.l=!0;return this};Z.prototype.set=Z.prototype.w;Z.prototype.A=function(a){return this.j(a).o};Z.prototype.fetch=Z.prototype.A;
Z.prototype.R=function(a){if(!this.f)throw Error(".create() is for creating models, not primitive values. Use .set() instead.");var b=this.a.j(),b=(new this.f(this.a.f(b))).o;a&&(b=b.then(function(b){return Pb(b,a)}));return b};Z.prototype.create=Z.prototype.R;Z.prototype.K=function(a,b){if(!this.f)throw Error(".fetchOrCreate() is for fetching/creating models, not primitive values");return(new this.f(this.a.f(a))).o.then(function(a){return b?Qb(a,b).then(function(){return a}):a})};
Z.prototype.fetchOrCreate=Z.prototype.K;Z.prototype.T=function(a){if(!this.m(a))return M(null);var b,c=this;return(this.f?this.A(a):M(this.i(a))).then(function(a){b=a}).then(function(){c.s[a]=null;c.l=!0;return c.I()}).then(function(){return P(c.a,"child_removed",b,a)}).then(function(){b instanceof X&&b.G()})};Z.prototype.remove=Z.prototype.T;Z.prototype.forEach=function(a){var b=[],c;for(c in this.b){var d=this.f?this.A(c):M(this.i(c)),d=d.then(function(b){return a.call(null,b,c)});b.push(d)}return N(b)};
Z.prototype.forEach=Z.prototype.forEach;Z.prototype.P=function(){return this.h};Z.prototype.count=Z.prototype.P;Z.prototype.m=function(a){return!!this.b&&a in this.b};Z.prototype.containsKey=Z.prototype.m;Z.prototype.S=function(){return ra(this.b)};Z.prototype.keys=Z.prototype.S;Z.prototype.L=function(a){this.b||(this.b={});var b=a.key(),c=!this.m(b);this.b[b]=a.val();c&&this.h++};Z.prototype.M=function(a){a=a.key();this.m(a)&&(delete this.b[a],this.h--,0===this.h&&(this.b=null))};function Rb(a){switch(typeof a){case "function":return a;case "object":break;default:throw Error("Invalid schema - it must be an object or a constructor!");}return n(a)===p?Sb(a):Tb(a)}function Tb(a){function b(b){X.call(this,b);Nb(this,a)}fa(b,X);Ub(b,a);return b}function Sb(a){function b(a){Z.call(this,a,c)}a=a.$id;var c;switch(n(a)){case ga:c=a;break;case r:case p:c=Tb(a)}fa(b,Z);return b}

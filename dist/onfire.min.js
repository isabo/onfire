...
W.prototype.onceValue = W.prototype.C;
...
W.prototype.offValue = W.prototype.B;
...
X.prototype.D = function() {
  return this.j ? Db(this, this.l).then(function(a) {
    a.l = {};
    a.j = !1;
    return a;
  }) : M(this);
};
X.prototype.save = X.prototype.D;
X.prototype.G = function() {
  return this.j;
};
X.prototype.hasChanges = X.prototype.G;
function Db(a, b) {
  var c = a.h, d = {}, e;
  for (e in b) {
    d[e] = a.f(e);
...
Z.prototype.fetch = Z.prototype.o;
...
Z.prototype.create = Z.prototype.K;
...
Z.prototype.fetchOrCreate = Z.prototype.F;
Z.prototype.M = function(a) {
  if (!this.s(a)) {
    return M(null);
  }
  var b, c = this;
  return (this.b ? this.o(a) : M(this.i(a))).then(function(a) {
    b = a;
  }).then(function() {
    c.v(a, null);
    return c.D();
...
Z.prototype.forEach = function(a) {
  var b = [], c;
  for (c in this.g) {
    var d = this.b ? this.o(c) : M(this.i(c));
    d.then(function(b) {
...
Z.prototype.count = Z.prototype.H;
Z.prototype.s = function(a) {
  return a in this.g;
};
Z.prototype.containsKey = Z.prototype.s;
Z.prototype.L = function() {
  return ra(this.g);
};
Z.prototype.keys = Z.prototype.L;
function Fb(a) {
  switch(typeof a) {
    case "function":
      return a;
...
function Jb(a) {
  return function(b) {
    return 0 === arguments.length ? this.f(a) : this.v(a, b);
  };
}
function Kb(a) {
  return function() {

...
function(){b.onreadystatechange=null;b.parentNode.removeChild(b);b=null;a();a=null};document.documentElement.appendChild(b)}:function(a){e.setTimeout(a,0)}};function y(a,b){this.b={};this.a=[];this.f=this.c=0;var c=arguments.length;if(1<c){if(c%2)throw Error("Uneven number of arguments");for(var d=0;d<c;d+=2)z(this,arguments[d],arguments[d+1])}else if(a){if(a instanceof y)c=a.H(),d=a.I();else{var c=ra(a),f=[],l=0;for(d in a)f[l++]=a[d];d=f}for(f=0;f<c.length;f++)z(this,c[f],d[f])}}y.prototype.I=function(){Fa(this);for(var a=[],b=0;b<this.a.length;b++)a.push(this.b[this.a[b]]);return a};y.prototype.H=function(){Fa(this);return this.a.concat()};
...
function Mb(a,b){U(a);b=V(a,b);if(A(a.a.b,b)){a.b=null;a.c-=B(a.a,b).length;var c=a.a;A(c.b,b)&&(delete c.b[b],c.c--,c.f++,c.a.length>2*c.c&&Fa(c))}}S.prototype.clear=function(){this.a=this.b=null;this.c=0};S.prototype.H=function(){U(this);for(var a=this.a.I(),b=this.a.H(),c=[],d=0;d<b.length;d++)for(var f=a[d],l=0;l<f.length;l++)c.push(b[d]);return c};
S.prototype.I=function(a){U(this);var b=[];if("string"==typeof a){var c=a;U(this);c=V(this,c);A(this.a.b,c)&&(b=ta(b,B(this.a,V(this,a))))}else for(a=this.a.I(),c=0;c<a.length;c++)b=ta(b,a[c]);return b};S.prototype.toString=function(){if(this.b)return this.b;if(!this.a)return"";for(var a=[],b=this.a.H(),c=0;c<b.length;c++)for(var d=b[c],f=encodeURIComponent(String(d)),d=this.I(d),l=0;l<d.length;l++){var k=f;""!==d[l]&&(k+="="+encodeURIComponent(String(d[l])));a.push(k)}return this.b=a.join("&")};
S.prototype.clone=function(){var a=new S;a.b=this.b;this.a&&(a.a=this.a.clone(),a.c=this.c);return a};function V(a,b){var c=String(b);a.f&&(c=c.toLowerCase());return c}function Jb(a,b){b&&!a.f&&(U(a),a.b=null,a.a.forEach(function(a,b){var f=b.toLowerCase();if(b!=f&&(Mb(this,b),Mb(this,f),0<a.length)){this.b=null;var l=this.a,f=V(this,f),k;k=a.length;if(0<k){for(var q=Array(k),u=0;u<k;u++)q[u]=a[u];k=q}else k=[];z(l,f,k);this.c+=a.length}},a));a.f=b};function W(a){"string"===typeof a&&(a=la?new $a(a):new Firebase(a));this.a=a}m("onfire.Ref",W);W.prototype.authWithCustomToken=function(a,b){return gb(this.a,a,b)};W.prototype.authWithCustomToken=W.prototype.authWithCustomToken;W.prototype.B=function(a){return hb(this.a,a)};W.prototype.authAnonymously=W.prototype.B;W.prototype.G=function(a,b){return ib(this.a,a,b)};W.prototype.authWithPassword=W.prototype.G;W.prototype.C=function(a,b){return jb(this.a,a,b)};W.prototype.authWithOAuthPopup=W.prototype.C;
W.prototype.D=function(a,b){return kb(this.a,a,b)};W.prototype.authWithOAuthRedirect=W.prototype.D;W.prototype.F=function(a,b,c){return lb(this.a,a,b,c)};W.prototype.authWithOAuthToken=W.prototype.F;W.prototype.J=function(a){return nb(this.a,a)};W.prototype.changeEmail=W.prototype.J;W.prototype.K=function(a){return ob(this.a,a)};W.prototype.changePassword=W.prototype.K;W.prototype.L=function(a){return mb(this.a,a)};W.prototype.createUser=W.prototype.L;W.prototype.M=function(){return this.a.getAuth()};
W.prototype.getAuth=W.prototype.M;W.prototype.O=function(){this.a.goOnline()};W.prototype.goOnline=W.prototype.O;W.prototype.N=function(){this.a.goOffline()};W.prototype.goOffline=W.prototype.N;W.prototype.R=function(a,b){this.a.onAuth(a,b)};W.prototype.onAuth=W.prototype.R;W.prototype.P=function(a,b){this.a.offAuth(a,b)};W.prototype.offAuth=W.prototype.P;W.prototype.Y=function(){this.a.unauth()};W.prototype.unauth=W.prototype.Y;W.prototype.f=function(a){return new W(this.a.child(a))};
W.prototype.child=W.prototype.f;W.prototype.j=function(){return this.a.push().key()};W.prototype.generateId=W.prototype.j;W.prototype.o=function(){return this.a.key()};W.prototype.key=W.prototype.o;W.prototype.i=function(a,b,c){this.a.off(a,b,c)};W.prototype.off=W.prototype.i;W.prototype.A=function(a,b){this.i("value",a,b)};W.prototype.offValue=W.prototype.A;
...
W.prototype.T=function(){t("REMOVE "+this.b());var a=this;return eb(this.a).then(function(){t("REMOVE (Success) "+a.b());return null},function(b){v("REMOVE (Failure) "+a.b(),b);throw b;})};W.prototype.remove=W.prototype.T;W.prototype.U=function(a){return pb(this.a,a)};W.prototype.removeUser=W.prototype.U;W.prototype.V=function(a){return qb(this.a,a)};W.prototype.resetPassword=W.prototype.V;W.prototype.W=function(){return new W(this.a.root())};W.prototype.root=W.prototype.W;
W.prototype.X=function(a){t("SET "+this.b()+" :",a);var b=this;return bb(this.a,a).then(function(){t("SET (Success) "+b.b()+" :",a);return null},function(c){v("SET (Failure) "+b.b()+" :",a,c);throw c;})};W.prototype.set=W.prototype.X;W.prototype.v=function(a){t("TRANSACTION at "+this.b());var b=this;return db(this.a,a).then(function(a){t("TRANSACTION "+(a.isCommitted?"Committed":"Not Committed")+" at "+b.b()+" :",a.snapshot.val());return a},function(a){v("TRANSACTION Failed at "+b.b());throw a;})};
W.prototype.transaction=W.prototype.v;W.prototype.w=function(a){t("UPDATE "+this.b()+" :",a);var b=this;return cb(this.a,a).then(function(){t("UPDATE (Success) "+b.b()+" :",a);return null},function(c){v("UPDATE (Failure) "+b.b()+" :",a,c);throw c;})};W.prototype.update=W.prototype.w;function X(a){if(!(a instanceof W))throw Error("Invalid ref argument - it must be an onfire.Ref instance");this.a=a;this.u={};this.m=!1;this.h=0;this.g=null;this.F=[];this.v=[];this.s=this.L()}m("onfire.model.Model",X);X.prototype.j=function(){t("DISPOSE  "+this.a.b()+" ...");delete this.s;for(var a=0;a<this.v.length;a++)this.a.i.apply(this.a,this.v[a]);this.G=null;for(a=0;a<this.F.length;a++)this.F[a].j();t("DISPOSED "+this.a.b())};X.prototype.dispose=X.prototype.j;
function Nb(a,b){a.g=b;var c=[],d;for(d in a.g){var f;switch(n(a.g[d])){case ha:case ia:case ja:break;case r:case p:f=a[d+"Ctor_"];a[d+"Inst_"]=new f(a.a.f(d));c.push(a[d+"Inst_"].s);a.F.push(a[d+"Inst_"]);break;default:throw new TypeError("Invalid property type for "+d);}}a.s=a.s.then(function(){return N(c)}).then(function(){a.b=!0;return a});a.b=!1}
X.prototype.L=function(){var a=this;return L(function(b,c){a.b=!1;var d=a.a.l(function(c){var d=a.b;Ob(a,c);d||b(a)},function(b){a.b||c(b)});a.v.push(["value",d])})};X.prototype.$=function(){return this.s};X.prototype.whenLoaded=X.prototype.$;X.prototype.J=function(){return this.a.o()};X.prototype.key=X.prototype.J;X.prototype.Y=function(){if(!this.b)throw Error("Not loaded yet");return!!this.c};X.prototype.exists=X.prototype.Y;X.prototype.T=function(a){this.G=a};X.prototype.onValueChanged=X.prototype.T;
function Ob(a,b){a.c=b;a.h=ra(b).length;a.b=!0;a.G&&a.G.call(null)}X.prototype.w=function(a){return a in this.g&&"string"!==typeof this.g[a]?this.l(a):this.i(a)};X.prototype.get=X.prototype.w;X.prototype.i=function(a){if(!this.b)throw Error("Not loaded yet");if(this.c&&a in this.c)return this.c[a];if(a in this.g)return null;throw Error("No such key");};X.prototype.getBasicValue=X.prototype.i;
X.prototype.l=function(a){if(!this.b)throw Error("Not loaded yet");if(!(a in this.g))throw Error("No such key");if("string"===typeof this.g[a])throw Error("Not a model");return this[a+"Inst_"]};X.prototype.getModel=X.prototype.l;X.prototype.A=function(a,b){if(!this.b)throw Error("Not loaded yet");var c=a in this.g,d=this.c&&a in this.c;if(!c&&!d)throw Error("No such key");if(c&&"string"!==typeof this.g[a])throw Error("Not a primitive");this.u[a]=b;this.m=!0;return this};X.prototype.set=X.prototype.A;
X.prototype.P=function(){return this.m};X.prototype.hasChanges=X.prototype.P;X.prototype.K=function(){return this.m?Pb(this,this.u).then(function(a){a.u={};a.m=!1;return a}):M(this)};X.prototype.save=X.prototype.K;
function Pb(a,b){var c=a.h,d={},f;for(f in b)try{d[f]=a.i(f)}catch(l){}return a.a.w(b).then(function(){var c=[];for(f in b)if(d[f]!==b[f]){var l=a.a.f(f),l=P(l,"value",d[f],b[f]);c.push(l)}return N(c)}).then(function(){if(0<c&&0===a.h){t("REMOVED "+a.a.b());var b=a.a.h(),d=a.J();return P(b,"child_removed",a,d)}if(0===c&&0<a.h)return t("CREATED "+a.a.b()),rb(a.a.h(),a)}).then(function(){return a})}
function Qb(a,b){return a.a.v(function(a){if(null===a)return b}).then(function(b){return b.isCommitted?(t("CREATED "+a.a.b()),rb(a.a.h(),a).then(function(){return b})):b})};function Z(a,b){X.call(this,a);this.f=b}fa(Z,X);m("onfire.model.Collection",Z);Z.prototype.L=function(){var a=this,b=this.a.m().then(function(b){Ob(a,b);return a});b.then(function(){var b=a.a.g("child_added",a.N,void 0,a),d=a.a.g("child_removed",a.O,void 0,a);a.v.push(["child_added",b,a]);a.v.push(["child_removed",d,a])});return b};Z.prototype.j=function(){Z.aa.j.call(this);this.C=this.B=null};Z.prototype.dispose=Z.prototype.j;Z.prototype.w=function(a){return this.f?this.l(a):this.i(a)};
Z.prototype.get=Z.prototype.w;Z.prototype.l=function(a){if(!this.b)throw Error("Not loaded yet");if(!this.f)throw Error("Not a model");if(!this.o(a))throw Error("No such key");return new this.f(this.a.f(a))};Z.prototype.getModel=Z.prototype.l;Z.prototype.i=function(a){if(!this.b)throw Error("Not loaded yet");if(!this.o(a))throw Error("No such key");return this.c[a]};Z.prototype.getBasicValue=Z.prototype.i;
Z.prototype.A=function(a,b){if(!this.b)throw Error("Not loaded yet");if(this.f)throw Error("Not a primitive");this.u[a]=b;this.m=!0;return this};Z.prototype.set=Z.prototype.A;Z.prototype.D=function(a){return this.l(a).s};Z.prototype.fetch=Z.prototype.D;Z.prototype.V=function(a){if(!this.b)throw Error("Not loaded yet");if(!this.f)throw Error("Not a model");var b=this.a.j(),b=(new this.f(this.a.f(b))).s;a&&(b=b.then(function(b){return Pb(b,a)}));return b};Z.prototype.create=Z.prototype.V;
Z.prototype.M=function(a,b){if(!this.b)throw Error("Not loaded yet");if(!this.f)throw Error("Not a model");return(new this.f(this.a.f(a))).s.then(function(a){return b?Qb(a,b).then(function(){return a}):a})};Z.prototype.fetchOrCreate=Z.prototype.M;
Z.prototype.X=function(a){if(!this.b)throw Error("Not loaded yet");if(!this.o(a))return M(null);var b,c=this;return(this.f?this.D(a):M(this.i(a))).then(function(a){b=a}).then(function(){c.u[a]=null;c.m=!0;return c.K()}).then(function(){return P(c.a,"child_removed",b,a)}).then(function(){b instanceof X&&b.j()})};Z.prototype.remove=Z.prototype.X;
Z.prototype.forEach=function(a){if(!this.b)throw Error("Not loaded yet");var b=[],c;for(c in this.c){var d=this.f?this.D(c):M(this.i(c)),d=d.then(function(b){return a.call(null,b,c)});b.push(d)}return N(b)};Z.prototype.forEach=Z.prototype.forEach;Z.prototype.U=function(){if(!this.b)throw Error("Not loaded yet");return this.h};Z.prototype.count=Z.prototype.U;Z.prototype.o=function(a){if(!this.b)throw Error("Not loaded yet");return!!this.c&&a in this.c};Z.prototype.containsKey=Z.prototype.o;
Z.prototype.W=function(){if(!this.b)throw Error("Not loaded yet");return ra(this.c)};Z.prototype.keys=Z.prototype.W;Z.prototype.R=function(a){this.B=a};Z.prototype.onChildAdded=Z.prototype.R;Z.prototype.S=function(a){this.C=a};Z.prototype.onChildRemoved=Z.prototype.S;Z.prototype.N=function(a){this.c||(this.c={});var b=a.key(),c=!this.o(b);this.c[b]=a.val();c&&(this.h++,this.B&&this.B.call(null,a.key()))};
Z.prototype.O=function(a){var b=a.key();this.o(b)&&(delete this.c[b],this.h--,0===this.h&&(this.c=null),this.C&&this.C.call(null,a.key()))};function Rb(a){switch(typeof a){case "function":return a;case "object":break;default:throw Error("Invalid schema - it must be an object or a constructor!");}return n(a)===p?Sb(a):Tb(a)}function Tb(a){function b(b){X.call(this,b);Nb(this,a)}fa(b,X);Ub(b,a);return b}function Sb(a){function b(a){Z.call(this,a,c)}a=a.$id;var c;switch(n(a)){case ga:c=a;break;case r:case p:c=Tb(a)}fa(b,Z);return b}
...
c);}}}function Vb(a){return function(b){return 0===arguments.length?this.w(a):this.A(a,b)}}function Wb(a){return function(){return this.w(a)}};m("onfire.defineModel",Rb);la&&(module.exports=e.onfire);})();//# sourceMappingURL=./onfire.min.js.map
